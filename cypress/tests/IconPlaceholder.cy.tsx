...
describe('tests for IconPlaceholder', () => {
    ...
    describe('test props', () => {
        it('test styles -- iconContainer', () => {
            cy.mount(<IconPlaceholder styles={{ iconContainer: baseStyle => ({ ...baseStyle, border: '1px solid red' }) }}/>);
            verifyComputedStyle('[data-testid=ip-iconPlaceholderContainer]', {
                ...ICON_CONTAINER_BASE_STYLE,
                visibility: 'hidden'
            }, {
        ...
        it('test styles -- icon', () => {
            cy.mount(<IconPlaceholder styles={{ icon: baseStyle => ({ ...baseStyle, border: '1px solid red' }) }}/>);
            verifyComputedStyle('[data-testid=ip-iconPlaceholder]', ICON_BASE_STYLE({ hex: '#000000' }), {
                border: ['1px solid red'],
                color: ['rgb(0, 0, 0)']
            });
