...
import { SEARCH_CONTAINER_BASE_STYLE, SEARCH_ICON_BASE_STYLE, SEARCH_INPUT_BASE_STYLE } from "../../lib/styles";
...
export const IconSearch = memo((props: IconSearchProps) => {
    ...
    >
        ...
        <input
            ...
            onChange={(e: ChangeEvent<HTMLInputElement>) => typeof onSearchValueChange === 'function' && onSearchValueChange(e.target.value)}
            placeholder={searchBoxPlaceholder || "Search"}
            ref={searchInputRef}
            onKeyDown={(e: KeyboardEvent<HTMLInputElement>) => e.key === 'Enter' && setIconSearch(searchInputRef.current?.value || '')}
